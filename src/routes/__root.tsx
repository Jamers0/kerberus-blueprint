...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kerberus v2.0 — Documentação Técnica" },
      {
        name: "description",
        content:
          "Documentação técnica oficial do projeto Kerberus v2.0: arquitetura, topologia, VLANs, fluxos, roadmap e segurança.",
      },
      { property: "og:title", content: "Kerberus v2.0 — Documentação Técnica" },
      {
        property: "og:description",
        content: "Arquitetura, topologia, VLANs, fluxos, roadmap e segurança do projeto Kerberus v2.0.",
      },
